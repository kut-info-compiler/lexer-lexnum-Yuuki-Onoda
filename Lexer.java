...
public class Lexer {
	...
	int[][] delta = {
		...
		/*...*/
	    {1,-1,3,5,7,-1},   /* (0)初期状態 */
	    {-1,-1,6,6,-1,-1}, /* (1)「.」から始まるとき */
	    {-1,-1,7,7,7,-1},  /* (2)「0x」から始まるとき */
	    {6,2,4,4,7,-1},  /* (3)「0」から始まるとき */
	    {-1,-1,4,4,7,-1},   /* (4)0[0-9]から始まるとき */
	    {6,-1,5,5,7,-1}, /* (5)INT[1-9]から始まるとき */
	    {-1,-1,6,6,-1,-1},   /* (6)DEC[1-9]から始まるとき */
	    {-1,-1,7,7,7,-1}   /* (7)[a-f]もしくは[A-F]から始まるとき */
	};
